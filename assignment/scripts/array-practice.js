...
favoriteFoods.unshift('porkBelly');
console.log(`Added a food to the favorites list: ${favoriteFoods}`);
...
console.log('Removed the first food on the list, ', removedFood);
console.log('The remaining food is ', favoriteFoods);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods.splice(1, 1, 'cheeseburgers');
console.log(favoriteFoods);
